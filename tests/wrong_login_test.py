...
class WrongCredentialsTest(unittest.TestCase):
    ...
    def test_wrong_credentials(self):
        ...
        # 3. check if notification: 'Username and password do not match any user in this service' is displayed
        messages_text = login_page.wrong_credentials_alert()
        self.assertEqual('Epic sadface: Username and password do not match any user in this service', messages_text,
